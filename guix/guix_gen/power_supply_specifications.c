...
CURRENT_WINDOW_CONTROL_BLOCK current_window;
VOLT_WINDOW_CONTROL_BLOCK volt_window;
...
GX_STUDIO_DISPLAY_INFO power_supply_display_table[1] =
{
    ...
    1024,                                    /* canvas memory size in bytes    */
...
GX_WINDOW_PROPERTIES current_window_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_PROMPT_PROPERTIES current_window_prompt_9_properties =
{
    GX_STRING_ID_STRING_20,                  /* string id                      */
    GX_FONT_ID_YAHEI,                        /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
GX_PROMPT_PROPERTIES current_window_prompt_10_properties =
{
...
GX_PROMPT_PROPERTIES current_window_prompt_11_properties =
{
...
GX_CONST GX_STUDIO_WIDGET current_window_prompt_11_define =
{
    "prompt_11",
    ...
    {96, 29, 111, 50},                       /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(CURRENT_WINDOW_CONTROL_BLOCK, current_window_prompt_11), /* control block */
    (void *) &current_window_prompt_11_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET current_window_prompt_10_define =
{
    "prompt_10",
    GX_TYPE_PROMPT,                          /* widget type                    */
    max_current,                             /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {13, 27, 92, 50},                        /* widget size                    */
    &current_window_prompt_11_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(CURRENT_WINDOW_CONTROL_BLOCK, current_window_prompt_10), /* control block */
    (void *) &current_window_prompt_10_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET current_window_prompt_9_define =
{
    "prompt_9",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {2, 2, 85, 17},                          /* widget size                    */
    &current_window_prompt_10_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(CURRENT_WINDOW_CONTROL_BLOCK, current_window_prompt_9), /* control block */
    (void *) &current_window_prompt_9_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET current_window_define =
{
    "current_window",
    ...
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(CURRENT_WINDOW_CONTROL_BLOCK),    /* control block size             */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 0, 127, 63},                         /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &current_window_prompt_9_define,         /* child widget                   */
    0,                                       /* control block                  */
    (void *) &current_window_properties      /* extended properties            */
};
GX_WINDOW_PROPERTIES volt_window_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_PROMPT_PROPERTIES volt_window_prompt_12_properties =
{
...
GX_PROMPT_PROPERTIES volt_window_prompt_13_properties =
{
    GX_STRING_ID_STRING_17,                  /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_PROMPT_PROPERTIES volt_window_prompt_14_properties =
{
...
GX_CONST GX_STUDIO_WIDGET volt_window_prompt_14_define =
{
    "prompt_14",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {99, 31, 110, 48},                       /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(VOLT_WINDOW_CONTROL_BLOCK, volt_window_prompt_14), /* control block */
    (void *) &volt_window_prompt_14_properties /* extended properties          */
};

GX_CONST GX_STUDIO_WIDGET volt_window_prompt_13_define =
{
    "prompt_13",
    GX_TYPE_PROMPT,                          /* widget type                    */
    out_volt_set,                            /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {12, 27, 91, 50},                        /* widget size                    */
    &volt_window_prompt_14_define,           /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(VOLT_WINDOW_CONTROL_BLOCK, volt_window_prompt_13), /* control block */
    (void *) &volt_window_prompt_13_properties /* extended properties          */
};

GX_CONST GX_STUDIO_WIDGET volt_window_prompt_12_define =
{
    "prompt_12",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {1, 1, 88, 20},                          /* widget size                    */
    &volt_window_prompt_13_define,           /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(VOLT_WINDOW_CONTROL_BLOCK, volt_window_prompt_12), /* control block */
    (void *) &volt_window_prompt_12_properties /* extended properties          */
};

GX_CONST GX_STUDIO_WIDGET volt_window_define =
{
    "volt_window",
    GX_TYPE_WINDOW,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_STYLE_BORDER_THIN|GX_STYLE_ENABLED,   /* style flags                    */
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(VOLT_WINDOW_CONTROL_BLOCK),       /* control block size             */
    GX_COLOR_ID_WINDOW_FILL,                 /* normal color id                */
    GX_COLOR_ID_WINDOW_FILL,                 /* selected color id              */
    GX_COLOR_ID_DISABLED_FILL,               /* disabled color id              */
    gx_studio_window_create,                 /* create function                */
    ...
    {0, 0, 127, 63},                         /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &volt_window_prompt_12_define,           /* child widget                   */
    0,                                       /* control block                  */
    (void *) &volt_window_properties         /* extended properties            */
};
...
GX_PROMPT_PROPERTIES main_window_prompt_8_properties =
{
    GX_STRING_ID_STRING_19,                  /* string id                      */
    GX_FONT_ID_TIPS,                         /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};

GX_CONST GX_STUDIO_WIDGET main_window_prompt_8_define =
{
    "prompt_8",
    GX_TYPE_PROMPT,                          /* widget type                    */
    a_ma,                                    /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {106, 47, 129, 60},                      /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_prompt_8), /* control block */
    (void *) &main_window_prompt_8_properties /* extended properties           */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_prompt_7_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {37, 45, 97, 62},                        /* widget size                    */
    &main_window_prompt_8_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET_ENTRY power_supply_widget_table[] =
{
    { &current_window_define, (GX_WIDGET *) &current_window },
    { &volt_window_define, (GX_WIDGET *) &volt_window },
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = power_supply_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &power_supply_display_table[display];
